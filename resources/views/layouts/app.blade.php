        ...
        <div class="page-wrapper">
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                ...
                <p class="text-muted text-center text-md-left mb-0 d-none d-md-block">
                    Powered by: <a href="https://www.facebook.com/nelban.betache.1">MCC Dev Team</a>
                </p>
            </footer>
        </div>
    </div>
...
<script>
    ...
    var sessionLifetimeMinutes = {{ config('session.lifetime', 5) }}; // Default to 5 minutes if not set
