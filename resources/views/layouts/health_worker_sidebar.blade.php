<nav class="sidebar">
    <div class="sidebar-header">
        <a href="{{ URL::to('health-worker/dashboard') }}" class="sidebar-brand" onclick="showLoading();">M<small>enstrual</small> <span class="font-weight-bold">M<small>onitoring</small></span></a>
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{ URL::to('health-worker/dashboard') }}" class="nav-link" onclick="showLoading();">
            ...
            <li class="nav-item">
                <a href="{{ URL::to('health-worker/feminine-list') }}" class="nav-link" onclick="showLoading();">
                    ...
                    <span class="link-title">Female List</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ URL::to('health-worker/calendar') }}" class="nav-link" onclick="showLoading();">
            ...
            <li class="nav-item">
                <a href="{{ URL::to('health-worker/account') }}" class="nav-link" onclick="showLoading();">
